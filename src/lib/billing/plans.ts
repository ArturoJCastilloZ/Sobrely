...
export const PLANS: readonly Plan[] = [
  ...
  },
  {
    ...
    features: ["csv_export", "guest_management"],
    comingSoon: [],
    branding: "reduced",
    isRecommended: false,
    isActive: true,
  ...
  },
  {
    ...
    description:
      "Todos los módulos de contenido, sin branding, con personalización avanzada y tu propio arte: sube el diseño que ya tienes.",
    billingType: "per_event",
    priceLaunch: 399,
    priceRegular: 499,
    currency: "MXN",
    ...
    highlights: [
      ...
      "Arte propio: tu imagen de fondo y tus stickers",
